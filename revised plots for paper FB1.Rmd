...
#this does not work
#ggplot(plot.data.fci, aes(x=condition, y=mean.correct))+
 # geom_bar(stat='identity', fill="forest green")+
  #ylab("Proportion of container A choices")+
  #xlab("Group")+
  #ylim(0,1)



#ggplot2.barplot(data=plot.data.fci, 
 #   faceting=TRUE, facetingVarNames=c( "group", "fci group"))
